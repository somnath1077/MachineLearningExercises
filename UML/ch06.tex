...
$\hypclass$.  For such a function to exists, it would have to map an interval
around $c_2$ to $-1$ and the rest of the reals to $1$ and that also map $c_4$
to $1$. This shows that $\vcdim (\hypclass) \leq 3$ and hence 
$\vcdim(\hypclass) = 3$.  
