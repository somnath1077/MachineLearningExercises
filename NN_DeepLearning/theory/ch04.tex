...
\end{figure}
A plot of the tower function created by the above network for the rectangular 
region $(1.0, 5.0) \times (-2.0, 3.0)$ is shown in Figure~\ref{fig:tower_function_plot}.
\begin{figure}[ht]
\begin{center}
